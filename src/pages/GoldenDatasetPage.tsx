  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-12 text-center">
        ...
        <h2 className="text-lg font-medium text-gray-900 mb-1">{t('golden.comingSoon')}</h2>
        <p className="text-sm text-gray-500 max-w-md mx-auto">{t('golden.comingSoonDesc')}</p>
      </div>
    </div>
  );
}
