...
export const translations = {
  ...
  'nav.annotationDocs': { es: 'Documentos', en: 'Documents' },
  'nav.annotationStock': { es: 'Stock', en: 'Stock' },
  'nav.goldenDataset': { es: 'Golden Dataset', en: 'Golden Dataset' },
  'nav.goldenDatasets': { es: 'Golden Datasets', en: 'Golden Datasets' },
  'nav.goldenDatasetDocs': { es: 'Documentos', en: 'Documents' },
  'nav.goldenDatasetStock': { es: 'Stock', en: 'Stock' },
  'nav.test': { es: 'Test', en: 'Test' },
  'nav.tests': { es: 'Tests', en: 'Tests' },
