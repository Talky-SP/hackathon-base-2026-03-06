...
export const translations = {
  ...
  'annotation.action.markedReviewed': { es: 'Documento marcado como revisado', en: 'Document marked as reviewed' },
  'annotation.action.savedToGolden': { es: 'Guardado en dataset dorado', en: 'Saved to golden dataset' },
  'annotation.action.saveFailed': { es: 'Error al guardar la anotacion. Intentalo de nuevo.', en: 'Failed to save annotation. Please try again.' },
  'annotation.action.cannotSubmitLocal': { es: 'No se pueden enviar archivos locales. Solo documentos importados.', en: 'Cannot submit local files. Only imported documents can be annotated.' },

  // ─── Dataset selection modal ─────────────────────────────────────────────
  'annotation.dataset.selectTitle': { es: 'Seleccionar Dataset', en: 'Select Dataset' },
  'annotation.dataset.cancel': { es: 'Cancelar', en: 'Cancel' },
  'annotation.dataset.confirm': { es: 'Confirmar', en: 'Confirm' },
  'annotation.dataset.loading': { es: 'Cargando datasets...', en: 'Loading datasets...' },
  'annotation.dataset.selectLabel': { es: 'Dataset', en: 'Dataset' },
  'annotation.dataset.noDatasets': { es: 'Sin datasets disponibles', en: 'No datasets available' },
  'annotation.dataset.documents': { es: 'docs', en: 'docs' },
  'annotation.dataset.types': { es: 'Tipos', en: 'Types' },
  'annotation.dataset.createNew': { es: 'Crear nuevo dataset', en: 'Create new dataset' },
  'annotation.dataset.nameLabel': { es: 'Nombre del dataset', en: 'Dataset name' },
  'annotation.dataset.namePlaceholder': { es: 'Ej: Golden Dataset Q1 2026', en: 'e.g., Golden Dataset Q1 2026' },
  'annotation.dataset.descriptionLabel': { es: 'Descripcion', en: 'Description' },
  'annotation.dataset.descriptionPlaceholder': { es: 'Descripcion opcional del dataset...', en: 'Optional dataset description...' },
  'annotation.dataset.optional': { es: 'opcional', en: 'optional' },
  'annotation.dataset.back': { es: 'Atras', en: 'Back' },
  'annotation.dataset.create': { es: 'Crear', en: 'Create' },
  'annotation.dataset.addedToDataset': { es: 'Documento anadido al dataset', en: 'Document added to dataset' },
